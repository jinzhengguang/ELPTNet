        ...
        for i in range(len(dataset)):
            ...
            if i in frame_first_dict.keys():
                ...
                for ob_id in objects.keys():
                    ...
                    # jrdb
                    print('%d %d %s 0 0 -1 -1 -1 -1 -1 %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f'
                          % (i, ob_id, tracking_type, box[0], box[1], box[2], box[5], box[3], box[4], box[6], score), file=f)
    return proc_time
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default="jrdb.yaml",
