...
class JRDB3DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': 'data/trackerjrdb19',  # Location of GT data
            'TRACKERS_FOLDER': 'data/dt',
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        data_keys = ['ids', 'classes', 'dets','dets_3d']
        if is_gt:
        ...
        for t in range(num_timesteps):
            ...
            if time_key in read_data.keys():
                ...
                raw_data['dets_3d'][t] = np.empty((0, 7))
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        for t in range(raw_data['num_timesteps']):
            ...
            gt_dets_3d = raw_data['gt_dets_3d'][t][gt_class_mask]
            ...
            # print(raw_data['tracker_dets_3d'][t].shape)
            # print(asdasd)
            tracker_dets_3d = raw_data['tracker_dets_3d'][t][tracker_class_mask]
            ...
            unmatched_tracker_dets_3d = tracker_dets[unmatched_indices, :]
            ...
            data['tracker_dets_3d'][t] = tracker_dets_3d
