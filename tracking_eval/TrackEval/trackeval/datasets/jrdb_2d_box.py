...
class JRDB2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join(code_path, 'data/gt/jrdb/jrdb_2d_box_train'),  # Location of GT data
            'TRACKERS_FOLDER': os.path.join(code_path, '/pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/2dt/2021-11-11 09:42:22+00:00_jrmot/'),  # Trackers location
            #/pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/2dt/2021-10-28 05:27:59+00:00_tracktor_output_public_format/
            #/pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/2dt/2021-10-28 05:47:10+00:00_jrmot/
            # /pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/2dt/2021-10-28 04:51:29+00:00_deepsort/
            'OUTPUT_FOLDER': None,  # Where to save eval results (if None, same as TRACKERS_FOLDER)
            'TRACKERS_TO_EVAL': None,  # Filenames of trackers to eval (if None, all in folder)
            'CLASSES_TO_EVAL': ['pedestrian'],  # Valid: ['car', 'pedestrian']
            'SPLIT_TO_EVAL': 'test',  # Valid: 'training', 'val', 'training_minus_val', 'test'
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        for t in range(raw_data['num_timesteps']):
            ...
            #print(unmatched_heights,self.min_height)
            # Apply preprocessing to remove all unwanted tracker dets.
            #print(is_too_small, is_within_crowd_ignore_region)
        ...
        #print('unique id',len(unique_gt_ids))
        #print('unique id',len(unique_tracker_ids))
        data['num_gt_ids'] = len(unique_gt_ids)
        data['num_timesteps'] = raw_data['num_timesteps']
        data['seq'] = raw_data['seq']
        #print('end',data['gt_ids'][0],data['tracker_ids'][0])
