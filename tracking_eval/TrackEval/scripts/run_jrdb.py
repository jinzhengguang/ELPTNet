...
if __name__ == '__main__':
    ...
    default_dataset_config = trackeval.datasets.JRDB2DBox.get_default_dataset_config()
    default_metrics_config = {'METRICS': ['HOTA', 'CLEAR', 'Identity','OSPA']}
    ...
    dataset_list = [trackeval.datasets.JRDB2DBox(dataset_config)]
    metrics_list = []
    for metric in [trackeval.metrics.HOTA, trackeval.metrics.CLEAR, trackeval.metrics.Identity,trackeval.metrics.OSPA]:
